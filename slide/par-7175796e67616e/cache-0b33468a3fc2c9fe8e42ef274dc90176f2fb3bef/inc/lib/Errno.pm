...
"x86_64-linux-thread-multi-2.6.28-19-generic" or
	die "Errno architecture (x86_64-linux-thread-multi-2.6.28-19-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
